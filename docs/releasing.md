...
After publishing `v0.3.3`, verify the immutable release and a
downloaded asset with GitHub CLI:

```bash
gh release verify v0.3.3
gh release verify-asset v0.3.3 sb-heartbeat_0.3.3_linux_amd64.tar.gz
gh attestation verify sb-heartbeat_0.3.3_linux_amd64.tar.gz \
